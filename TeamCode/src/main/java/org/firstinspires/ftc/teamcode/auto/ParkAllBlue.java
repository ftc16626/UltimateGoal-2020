...
@Autonomous(name = "ParkAll Blue", group = "Autonomous Blue")
public class ParkAllBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (height.equals("FOUR")) {  //Zone C
            ...
            Trajectory two = drive.trajectoryBuilder(new Pose2d(34.0, 54.0, 0.0))
                    .lineToLinearHeading(new Pose2d(0.0, 54.0, 0.0))
                    .build();
